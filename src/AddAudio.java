 ...
 JFrame wait;
	...
	public AddAudio() {
		...
		change.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
            	videoFile = Player.chooseFile(new FileNameExtensionFilter("Video File", "avi", "mp4"),  JFileChooser.FILES_ONLY, "video file");
		...
		change1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
            	 audioFile = Player.chooseFile(new FileNameExtensionFilter("MP3", "mp3"),  JFileChooser.FILES_ONLY, "audio file");
